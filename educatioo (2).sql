...
-- Tiempo de generación: 22-02-2022 a las 03:05:34
...
(2, 'Level 1', '2021-12-23 02:49:14', '2022-02-11 00:04:41');
...
(1, 'Basic', '2021-12-23 03:05:57', '2021-12-23 03:05:57'),
(2, 'Premium plan', '2022-02-11 00:04:53', '2022-02-11 00:04:53');
...
INSERT INTO `users` (`id`, `image`, `name`, `email`, `password`, `role`, `school`, `land_id`, `created_at`, `updated_at`, `last_session`, `subscription_date`, `plan`, `total_students`, `remember_token`) VALUES
(1, '/star-admin/images/faces/face10.jpg', 'Yeny Firvida ', 'yfirvida@yahoo.es', '$2y$10$.P.ebgafhpIVCdYjMXlF/O6T7c.JUB7V5lclU3mAiMvsrtl1cdVte', 'admin', NULL, 150, '2021-12-18 19:32:53', '2022-01-03 19:03:18', NULL, '2021-12-09', 'Basic', 0, NULL),
(2, NULL, 'Trainer one l', 'admin@me.com', '$2y$10$.P.ebgafhpIVCdYjMXlF/O6T7c.JUB7V5lclU3mAiMvsrtl1cdVte', 'trainer', 'some school', 150, '2021-12-23 03:25:35', '2021-12-23 09:19:45', NULL, '2021-12-22', 'Basic', NULL, NULL),
(3, NULL, 'testing something', 'otheremail@mail.com', '$2y$10$yn4uAkHk6BdhdIKLvnOvsOLTheDHLgb67r1Euq.hSEMNy/2g2Kb4a', 'trainer', 'school test', 19, '2021-12-23 03:29:26', '2022-02-17 20:01:34', NULL, '2021-12-23', 'Basic', NULL, NULL),
(7, NULL, 'Yeny', 'me@me.com', '$2y$10$r2whwT5WabR0rTgIFPN4cuYDLeIXCWB/xc0ISV5Y2uG.Z9uCJx7nm', 'trainer', 'testg', 150, '2022-01-19 21:48:18', '2022-02-17 20:14:36', NULL, '2022-03-03', 'Basic', NULL, NULL),
(17, NULL, 'Yeny Test Role', 'yfirvida@yyy.com', '$2y$10$twqzfpX/h71jJURT2BGvT.4Sm/FQFiRlWM20yyGIi9ic.pjMUy7pS', 'trainer', NULL, 150, '2022-02-22 08:04:45', '2022-02-22 08:04:45', NULL, NULL, 'Basic', NULL, NULL),
(15, NULL, 'Yeny Test Role', 'yfirvida@gmail.com', '$2y$10$Uzg60uvFQiHCq6vt2St3RuIUtzPdhaeQE5NaMaWzDunemNGXPSQP6', 'trainer', NULL, 150, '2022-02-22 08:02:48', '2022-02-22 08:02:48', NULL, NULL, 'Premium', NULL, NULL),
(16, NULL, 'Yeny Firvida', 'yfirvida@some.com', '$2y$10$XSm0rwNfbmdrIytheSdAAO6zO2Blw.bhIjelPspaANJgLZTBw1blG', 'trainer', 'testing', 150, '2022-02-22 08:04:12', '2022-02-22 08:04:12', NULL, NULL, 'Premium', NULL, NULL);
COMMIT;
